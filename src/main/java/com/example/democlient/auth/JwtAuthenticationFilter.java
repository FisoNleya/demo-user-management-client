...
import com.example.democlient.auth.dtos.ValidUser;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            HttpEntity entity = new HttpEntity(new ValidateTokenRequest(jwt), headers);
            ResponseEntity<ValidUser> res = restTemplate.exchange(userServiceUrl + "/api/v1/users/valid", HttpMethod.POST, entity, ValidUser.class);
